// Service configuration mirrored from evangelo-sommer Becky CRM
export interface ServiceType {
  name: string;
  descriptionTemplate: string;
}

export const serviceTypesConfig: Record<string, ServiceType[]> = {
  creative: [
...
// Helper to get service types by slug
export function getServiceTypesBySlug(slug: string): ServiceType[] {
  return serviceTypesConfig[slug] || [];
}
